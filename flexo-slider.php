			...
			/*  proverka true/false za title  i link*/
				...
				if($chosen_gallery['img_title']=='true'):
								...
								if($chosen_gallery ['img_link']=='true') {
									...
									$sliderPicsHTML .= '<a href="' . $new_rezult->description . '"><img src="' . $dirresult[0]->path . '/' . $new_rezult->filename . '" alt="' . $new_rezult->alttext . '" title="' . $new_rezult->alttext.$img_des.'"></a>';
									}	
								}
								else {
									foreach ($new_rezult as $new_rezult) {
									...
									$sliderPicsHTML .= '<img src="' . $dirresult[0]->path . '/' . $new_rezult->filename . '" alt="' . $new_rezult->alttext.'"  title="' . $new_rezult->alttext .$img_des. '">';
									}
								}
