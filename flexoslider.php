...
?>
	<div id="flexo_slider_page">
			<form method="POST">
				...
				</br>Link на снимката	<input  type="radio" name="img_link" value="true" checked <?php echo $img_link == 'true' ? 'checked' : ''; ?> /> да
									 						<input  type="radio" name="img_link" value="false"<?php echo $img_link == 'false' ? 'checked' : ''; ?>/> не
									 						
				</br>Покажи име на снимката	<input  type="radio" name="img_title" value="true" checked <?php echo $img_title == 'true' ? 'checked' : ''; ?> /> да
									 									<input  type="radio" name="img_title" value="false" <?php echo $img_title == 'false' ? 'checked' : ''; ?>/> не
									 									
				</br>Покажи навигация	<input  type="radio" name="img_nav" value="true" checked <?php echo $img_nav == 'true' ? 'checked' : ''; ?> /> да
									 						<input  type="radio" name="img_nav" value="false" <?php echo $img_nav == 'false' ? 'checked' : ''; ?>/> не
				...
				</br>Пауза при мишка в/у симката <input  type="radio" name="pause" value="true" checked <?php echo $pause == 'true' ? 'checked' : ''; ?> /> да
									 									 		 <input  type="radio" name="pause" value="false" <?php echo $pause == 'false' ? 'checked' : ''; ?>/> не
									 					
				</br>Стрелки предишна & следваща снимка<input  type="radio" name="nav_arrow" value="true" checked <?php echo $nav_arrow == 'true' ? 'checked' : ''; ?> /> да
									 									 		 				<input  type="radio" name="nav_arrow" value="false" <?php echo $nav_arrow == 'false' ? 'checked' : ''; ?>/> не
